...
function WebsitePreview({ project }: { project: CaseStudy }) {
  ...
  const local = project.demo && ['interview','chai','autoimport','servicehub'].includes(project.demo)
